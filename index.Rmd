...
Plotting the correlation between motor vehicle thefts and total burglaries we can see that the two attributes share a positive correlation as previously shown in the matrix.
...
### Conclusion
From the analysis I performed, there are positive correlations between each of the categories of crime. Since the correlations are positive, it indicates that as one crime level rises, so too do the others. The largest correlation was between motor vehicle theft and total burglary at 0.77 and the least was violent crime and theft at 0.45. Violent crime had the overall lowest correlation with any of the other categories ranging from 0.45 to 0.54. 

All of the categories displayed a negative trend in total occurrences from 2008 to 2018. Vehicle theft fell 52%, burglary 51.4%, theft by 18.64% and violent crime by 11.52%. When observing these changes by year, we can see that violent crime decreased by a mean value of 10.07% and a median of 0.23%, burglary by a mean of 15.14% and median of 5.02%, thefts by a mean of 10.65% and median of 2.57% and vehicle theft by a mean of 14.83% and median of 9.55% year over year.
